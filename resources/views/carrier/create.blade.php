...
<div class="row">
    ...
    <div class="col-md-6">
      <div class="form-group row">
        ...
        <div class="col-sm-9">
          <input type="text" class="form-control" required name="carrier_name" />
        </div>
      </div>
    </div>
  </div>
...
<div class="row">
      ...
      <div class="col-md-6">
          ...
          <div class="col-sm-9">
              <select class="form-control" required name="type_of_company">
...
<div class="row">
    <div class="col-md-6">
      <div class="form-group row">
        ...
        <div class="col-sm-9">
          <input type="text" class="form-control" required name="tax_id" />
        </div>
      </div>
    </div>
    ...
    <div class="col-md-6">
      <div class="form-group row">
        ...
        <div class="col-sm-9">
          <input type="text" class="form-control" required  name="NAIC"/>
        </div>
      </div>
    </div>
  </div>
...
<div class="row">
    <div class="col-md-6">
      <div class="form-group row">
        ...
        <div class="col-sm-9">
          <input type="tel" class="form-control" required name="fax" />
        </div>
      </div>
    </div>
    ...
    <div class="col-md-6">
      <div class="form-group row">
        ...
        <div class="col-sm-9">
          <input type="text" class="form-control" name="fax_type" />
        </div>
      </div>
    </div>
  </div>
...
<div class="row">
    ...
    <div class="col-md-6">
      <div class="form-group row">
        ...
        <div class="col-sm-9">
          <input type="text" class="form-control" name="email_type" />
        </div>
      </div>
    </div>
  </div>
...
<div class="row">
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" required name="agent_id"  />
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" required name="portal" />
                  </div>
                </div>
              </div>
            </div>
...
<div class="row">
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" name="portal_type"  />
                  </div>
                </div>
              </div>
...
<div class="col-md-6">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control" name="certification_req" required>
                        <option>Yes</option>
                        <option>No</option>
                        </select>
                    </div>
              ...
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" name="certification_notes"  />
                  </div>
                </div>
              </div>
            </div>
  ...
  <div class="row">
    <div class="col-md-6">
      <div class="form-group row">
        ...
        <div class="col-sm-9">
          <input type="text" class="form-control" required name="current_appointed_agents" />
        </div>
      </div>
    </div>
