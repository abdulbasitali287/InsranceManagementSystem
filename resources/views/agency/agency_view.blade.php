            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                  <div class="">
                  <img  src="{{ asset('storage/'.$agency->file) }}" height="100px" width="100px" alt="job image" title="job image">
                      </div>
                  </div>
                </div>
              </div>
  ...
  <div class="row">
              <!-- <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                  <div class="">
                  <img  src="{{ asset('storage/'.$agency->ein_letter) }}" height="100px" width="100px" alt="job image" title="job image">
              ...
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                  <div class="">
                  <img  src="{{ asset('storage/images/'. $agency->void_checks) }}" height="100px" width="100px" alt="job image" title="job image">
                      </div>
                  </div>
                </div>
              </div>
