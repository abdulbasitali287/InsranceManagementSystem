            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" name="display_name" value="{{ $product->display_name }}" required />
                  </div>
                </div>
              </div>
...
{{-- <div class="col-md-6">
  ...
  <div class="col-md-6">
      ...
      <div class="col-sm-9">
        <input type="text" class="form-control" name="in_house_agent" value="{{ $product->in_house_agent }}" required />
      ...
      <div class="col-sm-9">
          <select class="form-control" name="carrier" value="{{ $product->carrier }}" required>
          <option>ex</option>
          <option>ex</option>
          </select>
      </div>
...
<div class="col-md-6">
  <div class="form-group row">
    ...
    <div class="col-sm-9">
      <input type="text" class="form-control" name="agent_level" value="{{ $product->agent_level }}" required />
    </div>
  </div>
</div>
...
<div class="col-md-6">
  <div class="form-group row">
    ...
    <div class="col-sm-9">
      <input type="text" class="form-control" name="agency" value="{{ $product->agency }}" required />
    </div>
  </div>
</div>
...
<div class="col-md-6">
  <div class="form-group row">
    ...
    <div class="col-sm-9">
      <input type="text" class="form-control" name="downline" value="{{ $product->downline }}" required />
    </div>
  </div>
</div>
...
<div class="row">
  ...
  <div class="col-md-6">
    <div class="form-group row">
      ...
      <div class="col-sm-9">
        <input type="text" class="form-control" name="notes" value="{{ $product->notes }}" required />
      </div>
    </div>
  </div>
  ...
  <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="referral" value="{{ $product->referral }}" required />
                        </div>
                      </div>
                    </div>
...
<div class="row">
  <div class="col-md-6">
    ...
    <div class="col-sm-9">
        <select class="form-control" name="type_of_payout" value="{{ $product->agencyComission->type_of_payout }}" required>
        <option>ex</option>
        <option>ex</option>
        </select>
    </div>
      ...
      <div class="col-sm-9">
        <input type="text" class="form-control" name="percentage" value="{{ $product->agencyComission->percentage }}" required />
...
<div class="col-md-6">
  <div class="form-group row">
    ...
    <div class="col-sm-9">
      <input type="text" class="form-control" name="flat_free" value="{{ $product->agencyComission->flat_free }}" required />
    </div>
  </div>
</div>
<div class="col-md-6">
  <div class="form-group row">
    ...
    <div class="col-sm-9">
      <input type="text" class="form-control" name="initial_commission" value="{{ $product->agencyComission->initial_commission }}" required />
    </div>
  </div>
</div>
...
<div class="row">
  ...
  <div class="col-md-6">
    <div class="form-group row">
      ...
      <div class="col-sm-9">
        <input type="text" class="form-control" name="company_fee" value="{{ $product->agencyComission->company_fee }}" required />
      </div>
    </div>
  </div>
   <div class="col-md-6">
      ...
      <div class="col-sm-9">
          <select class="form-control" name="renewal_commission_difference" value="{{ $product->agencyComission->renewal_commission_difference }}" required>
...
<div class="col-md-6">
  <div class="form-group row">
    ...
    <div class="col-sm-9">
      <input type="text" class="form-control" name="add_additional_RN_commission" value="{{ $product->agencyComission->add_additional_RN_commission }}" required />
    </div>
  </div>
</div>
...
<div class="col-md-6">
  <div class="form-group row">
    ...
    <div class="col-sm-9">
      <input type="text" class="form-control" name="RN_commission" value="{{ $product->agencyComission->RN_commission }}" required />
    </div>
  </div>
</div>
</div>
<div class="row">
  <div class="col-md-6">
    <div class="form-group row">
      <label class="col-sm-3 col-form-label">Note</label>
      <div class="col-sm-9">
        <input type="text" class="form-control" name="notes" value="{{ $product->agencyComission->notes }}" required />
      </div>
    </div>
  </div>
...
<div class="row">
  <div class="col-md-6">
    ...
    <label class="col-sm-3 col-form-label">Type of Payout</label>
    <div class="col-sm-9">
        <select class="form-control" name="type_of_payout" value="{{ $product->downlineComission->type_of_payout }}" required>
        <option>Percentage</option>
        <option>Flat fee</option>
        </select>
    </div>
...
<div class="col-md-6">
  ...
  <label class="col-sm-3 col-form-label">Percentage</label>
  <div class="col-sm-9">
    <input type="text" class="form-control" name="percentage" value="{{ $product->downlineComission->percentage }}" required />
...
<div class="row">
  ...
  <div class="col-md-6">
    ...
    <label class="col-sm-3 col-form-label">Flat Free</label>
    <div class="col-sm-9">
      <input type="text" class="form-control" name="flat_free" value="{{ $product->downlineComission->flat_free }}" required />
...
<div class="col-md-6">
  <div class="form-group row">
    <label class="col-sm-3 col-form-label">Initial Commission</label>
    <div class="col-sm-9">
      <input type="text" class="form-control" name="initial_commission" value="{{ $product->downlineComission->initial_commission }}" required />
    </div>
  </div>
</div>
</div>
...
<div class="row">
    ...
    <div class="col-md-6">
      ...
      <label class="col-sm-3 col-form-label">Renewal Commission different?</label>
      <div class="col-sm-9">
          <select class="form-control" name="renewal_commission_difference" value="{{ $product->downlineComission->renewal_commission_difference }}" required>
          <option>yes</option>
          <option>No</option>
          </select>
      </div>
  ...
  <div class="col-md-6">
    <div class="form-group row">
      <label class="col-sm-3 col-form-label">Add additional RN Commission</label>
      <div class="col-sm-9">
        <input type="text" class="form-control" name="add_additional_RN_commission" value="{{ $product->downlineComission->add_additional_RN_commission }}" required />
      </div>
    </div>
  </div>
...
<div class="col-md-6">
  <div class="form-group row">
    <label class="col-sm-3 col-form-label">RN Commission</label>
    <div class="col-sm-9">
      <input type="number" class="form-control" name="RN_commission" value="{{ $product->downlineComission->RN_commission }}" required />
    </div>
  </div>
</div>
...
<div class="col-md-6">
  <div class="form-group row">
    <label class="col-sm-3 col-form-label">Note</label>
    <div class="col-sm-9">
      <input type="text" class="form-control" name="notes" value="{{ $product->downlineComission->notes }}"  />
    </div>
  </div>
</div>
